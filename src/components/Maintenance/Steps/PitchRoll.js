...
import BackImage from '../../pic/IFC_0_deg.png'
...
const PitchRoll = () => {
const [token, setToken, removeToken] = useSessionstorage('token');    const url = "https://" + sysIPAddress
    ...
    return (
        <div className="steps-content" style={StepImage} >{/* style={StepImage} */}
             <h2>Please rotate the aircraft in the direction,</h2>
             <h2> that sets System Azimuth to 0 degrees.</h2>
